                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" class="btn btn-costume btn-sm float-right" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> Produk</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table class="table" id="table"> 
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $p->komisi ?>%</td>
                                                    <td>
                                                        <a href="" data-toggle="modal" data-target="#edit<?= $p->id_produk  ?>" class="btn btn-xs btn-costume"><i class="fas text-light fa-edit"></i></a>
                                                        <a href="{{ route('hapusProduk', ['id_produk' => $p->id_produk]) }}" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-xs btn-danger"><i class="fas text-light fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                ...
                <div class="modal-body">
                    <div class="row form-group ">
                        <div class="col-sm-4 ol-md-6 col-xs-12 mb-2">
                            ...
                            <input type="file" class="dropify form-control" data-height="150" name="image" placeholder="Image">
                        </div>
                        <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <select name="id_kategori" class="form-control select" required>
                                        <option value="">-Pilih Kategori-</option>
                                        <?php foreach ($kategori as $k) : ?>
                                            <option value="<?= $k->id_kategori ?>" {{ $k->id_kategori == $p->id_kategori ? 'selected' : '' }}><?= $k->nm_kategori ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <select name="id_satuan" class="form-control select" id="" required>
                                        <option value="">-Pilih Satuan-</option>
                                        <?php foreach ($satuan as $s) : ?>
                                            <option value="<?= $s->id_satuan ?>" {{ $s->id_satuan == $p->id_satuan ? 'selected' : '' }}><?= $s->satuan ?></option>
                                        <?php endforeach ?>
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <input type="text" value="{{ $p->stok }}" class="form-control" name="stok" placeholder="cth : 1" required>
                                </div>
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <input type="text" value="{{ $p->harga_modal }}" class="form-control" name="harga_modal" placeholder="cth : 5000" required>
                                </div>    
                                ...
                                <div class="col-lg-4 mb-2">
                                    ...
                                    <input type="text" value="{{ $p->harga }}" class="form-control" name="harga" placeholder="cth : 5000" required>
                                </div>
                                <div class="col-lg-4 mb-2">
                                    <label for="">
                                        <dt>Komisi</dt>
