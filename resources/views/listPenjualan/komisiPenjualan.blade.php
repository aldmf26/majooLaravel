    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-10">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="float-left">Laporan komisi penjualan majoo <?= date('d M Y', strtotime($tgl1)) ?>
        ...
        <button data-toggle="modal" data-target="#modal-excel" class="btn btn-sm btn-costume float-right ml-2"><i class="fas fa-file-excel majoo"></i> Excel</button> -->
                                ...
                                <button data-toggle="modal" data-target="#rules"
                                    class="btn btn-sm btn-costume float-right ml-2"><i class="fas fa-cog majoo"></i>
                                    Setting</button>
                                <br><br>
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="all-tab"
                                            href="<?= route('komisiPenjualan') ?>" role="tab"
                                            aria-controls="all" aria-selected="true">All</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tkmr-tab"
                                            href="<?= route('resto', ['lokasi' => 'TAKEMORI', 'tgl1' => $tgl1, 'tgl2' => $tgl2]) ?>"
                                            role="tab" aria-controls="tkmr" aria-selected="false">Takemori</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="sdb-tab"
                                            href="<?= route('resto', ['lokasi' => 'SOONDOBU', 'tgl1' => $tgl1, 'tgl2' => $tgl2]) ?>"
                                            role="tab" aria-controls="sdb" aria-selected="false">Soondobu</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="orc-tab"
                                            href="<?= route('orchard', ['tgl1' => $tgl1, 'tgl2' => $tgl2]) ?>" role="tab"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-5 form-group">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input pilih_rules" type="radio" name="rules" value="komisi"
                                        lawan="pendapatan" <?= $komisi >= 1 ? 'checked' : '' ?>>
                            ...
                            <div class="col-5 form-group">
                                <div class="form-check">
                                    <!-- <input class="form-check-input" type="radio" name="rules[]" value="" checked> -->
                                    <input class="form-check-input pilih_rules" type="radio" name="rules"
                                        value="pendapatan" lawan="komisi" <?= $pendapatan >= 1 ? 'checked' : '' ?>>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-5">
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input komisi" type="radio" name="komisi"
                                        value="<?= $d->id_rules ?>" <?= $d->status == 1 ? 'checked required' : '' ?>>
                                    <label class="form-check-label"><strong><?= number_format($d->jumlah, 0) ?> = koimisi x
                                            <?= $d->persen ?></strong></label>
                                </div>
                                <?php endforeach; ?>
                            </div>
                            ...
                            <div class="col-5">
                                ...
                                <div class="form-check">
                                    <!-- <input class="form-check-input" type="radio" name="permission[]" value="" checked> -->
                                    <input class="form-check-input pendapatan" type="radio" name="komisi"
                                        value="<?= $d->id_rules ?>" <?= $d->status == 1 ? 'checked required' : '' ?>>
                                    <label class="form-check-label"><strong><?= number_format($d->jumlah, 0) ?> = komisi x
                                            <?= $d->persen ?></strong></label>
                                </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <button class="btn btn-sm btn-primary mt-2 float-right" type="button" data-toggle="collapse"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <select class="form-control" name="jenis[]">
                                                    <option value="komisi" <?= $d->jenis == 'komisi' ? 'selected' : '' ?>>
                                                        Komisi</option>
                                                    <option value="pendapatan"
                                                        <?= $d->jenis == 'pendapatan' ? 'selected' : '' ?>>Pendapatan
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-1">
                                            <?php if($d->status != 1): ?>
                                            <a href="<?= route('drop_rules', ['id_rules' => $d->id_rules, 'tgl1' => $tgl1, 'tgl2' => $tgl2])?>"
                                                onclick="return confirm('Apakah anda yakin');"
                                                class="btn btn-xs btn-danger"><i class="fas fa-trash text-light"></i></a>
                                            <?php else: ?>
                                            <button class="btn btn-xs btn-success" type="button" aria-readonly=""><i
                                                    class="fas fa-check-circle text-light"></i></button>
                                            <?php endif; ?>
                                        </div>
