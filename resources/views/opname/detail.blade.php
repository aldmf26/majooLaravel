    ...
    <div class="content">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <form action="{{ route('editStokAktual', ['kode_opname' => Request::get('kode_opname')]) }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                ...
                                @endif
                                <a target="_blank" href="<?= route('printOpname', ['kode_opname' => Request::get('kode_opname')]) ?>" class="btn btn-costume float-right ml-2"><i class="fas fa-print text-light"></i> Print</a>
                                <a target="_blank" href="<?= route('formulirOpname', ['kode_opname' => Request::get('kode_opname')]) ?>" class="btn btn-costume float-right ml-2"><i class="fas fa-print text-light"></i> formulir</a>
                            </div>
                            <div class="card-body">
                                <div id="table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($opname as $op) : ?>
                                                        ...
                                                        <?php if ($selisih > 0) : ?>
                                                            ...
                                                            <td>
                                                                <center><input type="text" name="stok_aktual[]" value="<?= $op->stok_aktual ?>" style="width: 120px; text-align: center;" class="form-control fill"></center>
                                                            </td>
                                                            <td><?= $selisih ?></td>
                                                            ...
                                                            <td>
                                                                <center><input type="text" name="catatan[]" value="<?= $op->catatan ?>" style="width: 120px; text-align: center;" class="form-control fill"></center>
                                                            </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                </tbody>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="<?= route('opname') ?>" class="btn btn-secondary">Kembali</a>
            
                                            <?php if($cek_status->status != 'Selesai') :?>
                                                <a href="<?= route('deleteOpname', ['kode_opname' => $kode_opname]) ?>" class="btn btn-outline-secondary" onclick="return confirm('Yakin ingin menghapus?')"><i class="fas fa-trash"></i></a>
                                               
                                                <button type="submit" name="action" value="selesai" class="btn btn-costume float-right ml-2">Selesai</button>
                                                <button type="submit" name="action" value="edit" class="btn btn-costume float-right ml-2">Edit</button>
