                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('buatOpname') }}" class="btn btn-costume btn-sm float-right ml-2" ><i class="fa fa-truck-loading"></i> Stok Opname</a>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-hover" width="100%" id="table">
                                            ...
                                            <tbody>
                                                ...
                                                $i=1;
                                                foreach ($opname as $d) : ?>
                                                    <tr onclick="window.location = '{{route('detailOpname', ['kode_opname' => $d->kode_opname])}}'">
                                                        <td><?=$i++;?></td>
